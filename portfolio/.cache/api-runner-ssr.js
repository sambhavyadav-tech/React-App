var plugins = [{
      ...
      plugin: require('/workspace/React-App/portfolio/node_modules/gatsby-plugin-theme-ui/gatsby-ssr.js'),
      options: {"plugins":[]},
    },{
      name: '@lekoarts/gatsby-theme-cara',
      plugin: require('/workspace/React-App/portfolio/node_modules/@lekoarts/gatsby-theme-cara/gatsby-ssr.tsx'),
      options: {"plugins":[]},
    },{
      name: 'gatsby-plugin-manifest',
      plugin: require('/workspace/React-App/portfolio/node_modules/gatsby-plugin-manifest/gatsby-ssr.js'),
      ...
      name: 'partytown',
      plugin: require('/workspace/React-App/portfolio/node_modules/gatsby/dist/internal-plugins/partytown/gatsby-ssr.js'),
      options: {"plugins":[]},
    }]
/* global plugins */
